Shader "Unlit/HighlightCubeShader"
{
    Properties
    {
        _MainTex ("Main Teuture", CUBE) = "white" {}
        ...
        _TranslationX ("Translation X", Range(-1, 1)) = 0.2
        _TranslationY ("Translation Y", Range(-1, 1)) = -0.6
        ...
        _SplitY ("Split Y", Range(0, 1)) = 0.2
        _SquareN ("Square N", Range(1, 10)) = 1
        _SquareScale ("Square Scale", Range(0, 1)) = 0.2
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(v2f i) : COLOR
            {
                ...
                return float4((ambient + (diffuse + specular) * atten + edge).rgb, 1.0);
            }
            ENDCG
        }
    }
